---
title: "デザイン思考とは — 調査ノート"
description: "デザイン思考は単一の方法論ではなく、designerly thinking・Stanford-IDEOメソッド・ビジネスDTの3層が混在します。abduction・framing・問題設定の往還を核心とする学術的系譜と形骸化パターンを整理した調査ノート。"
---
