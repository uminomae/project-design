...
本稿は「[信頼](/project-design/wiki/concepts/%E4%BF%A1%E9%A0%BC)」の定義・多層構造・日英翻訳ズレをめぐる学術文献を LLM（Claude / GPT）で横断調査し、pjdhiro が構成・検証した調査ノートです。pjdhiro 独自の理論ではなく、一般に参照できる文献群の整理です。
...
**Why（なぜ）**: 信頼は「プロジェクトデザイン論」の中核概念のひとつであり、[欠損駆動思考](/project-design/wiki/concepts/%E6%AC%A0%E6%90%8D%E9%A7%86%E5%8B%95%E6%80%9D%E8%80%83)との接続を見据えた理論基盤の構築が必要だった。単一分野の定義では捉えきれない多層性を明らかにするため。
