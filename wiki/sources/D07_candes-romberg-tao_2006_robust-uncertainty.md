...
圧縮センシングの本質は「少ない観察から構造を復元できる」という命題であり、これは「断片的な情報から全体を推定する」という認識論的問いと直結する。PD において、限られたリソース・観察・インタラクションから意味を構成するという行為は常に圧縮的な操作を含んでいる。また「スパース性という事前知識があれば、それを活かした問いかけ（サンプリング方法）によって少ない観察でも豊富な情報が得られる」という考え方は、プロジェクトにおける問いの設計と情報収集の効率の問いと響き合う。
