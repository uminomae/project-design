...
美学・芸術哲学の観点から、本書はプロジェクトデザイン論に複数の示唆を与える。第一に「ひとつの経験」の完結性——プロジェクトが単なるタスクの積み重ねでなく、始まりから充実ある終わりへと向かう統一体となる条件を問う。第二に「素材との格闘」——プロジェクトの成果物（デザイン・コード・文章）は素材の抵抗を通じてのみ形成される。抵抗なしの表現はない。第三に「知覚の教育」——プロジェクトの振り返りや評価は、経験の質を互いに言語化し知覚を鍛える実践として捉えられる。また「芸術の民主化」と「コミュニティの経験の共有」という視点は、プロジェクトの社会的文脈を問う PD の視座と共鳴する。
