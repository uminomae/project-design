---
title: "偶然・愛・論理（Chance, Love, and Logic, Peirce 1923）"
description: "Peirce（没後1923年に M. Cohen 編集で刊行）。偶然を実在とみなす『偶然主義（tychism）』、連続性を根本原理とする『連続主義（synechism）』、進化的な愛を宇宙の創造的原理とする『愛の進化論（agapism）』を含む論文集。プラグマティズムの創始者パースの宇宙論・進化論的形而上学を伝える。"
aliases: ["Chance, Love, and Logic", "tychism", "synechism", "agapism"]
