...
PD（プロジェクトデザイン論）においてOstromの研究は「プロジェクトの場」という概念と深く接続する。コモンズを維持するガバナンス制度は、参加者が「やること（Doing）」の規則を自分たちで設計・更新し続けるプロセスそのものであり、同時に信頼・相互監視・集団的アイデンティティという「起きていること（Being）」の次元が制度を支えている。Ostromが示した8原則は、プロジェクトが長期的に機能する条件の制度論的記述としても読める。また「コモンズの悲劇」モデルへの批判——個人が合理的な自己利益だけで動くという前提への異議——は、Love駆動開発の観点から「人間の協働は利己的計算以上のものによって駆動される」という主張と共鳴する。
