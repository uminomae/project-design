---
title: "生態系における破局的状態遷移"
description: "Scheffer ら (2001) Nature 総説。生態系が緩やかな環境変化に通常は滑らかに応答するが、ある条件下では急激な状態遷移によって中断されることを分野横断的に提示し、レジリエンス維持を中心とする管理戦略を提案した。"
aliases: ["Catastrophic shifts in ecosystems", "alternative stable states", "resilience"]
tags: [source, "D12", "原典解説"]
source:
  repo: "creation-space"
  path: "knowledge/wiki/D12/D12-S08_scheffer-2001.md"
  manifest_id: "D12-S08"
  oa_url: "https://www.gatsby.ucl.ac.uk/~pel/environment/catastrophe.pdf"
compiled: "2026-04-18"
status: 暫定
review_state: 未レビュー
---
...
- cs 側読解: `creation-space/knowledge/wiki/D12/D12-S08_scheffer-2001.md`（2026-04-13、Claude Opus 4.6, WebFetch、Abstract + 7 図キャプションのみ。本文は paywall）
