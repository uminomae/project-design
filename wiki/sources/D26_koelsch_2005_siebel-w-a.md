---
title: "音楽知覚の神経基盤に向けて — 7 モジュール統合モデル"
description: "Koelsch & Siebel (2005) Trends Cogn Sci 論文。音楽知覚を 7 つの時間階層的モジュール（特徴抽出 → 聴覚記憶 → ゲシュタルト → 音程分析 → 構造構築 → 再分析 → 意味）として統合し、ERP 成分との対応を体系化した。"
aliases: ["Towards a neural basis of music perception"]
