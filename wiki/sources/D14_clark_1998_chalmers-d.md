---
title: "拡張された心 — Clark & Chalmers"
description: "Clark & Chalmers (1998) Analysis 論文。認知が脳内のみに限定されず、外部資源と緊密に結合した場合に環境へと拡張されると論じた『extended mind』テーゼの古典。Otto と Inga の思考実験で能動的外在主義（active externalism）を提示した。"
aliases: ["The Extended Mind", "active externalism", "parity principle", "Otto and Inga"]
tags: [source, "D14", "原典解説"]
source:
  repo: "creation-space"
  manifest_id: "D14-S02"
  oa_url: "https://www.alice.id.tue.nl/references/clark-chalmers-1998.pdf"
compiled: "2026-04-19"
status: 暫定
review_state: 未レビュー
note: "cs 既要約なし、本ページは pd 側で WebFetch (TUE PDF) から直接読解"
---
