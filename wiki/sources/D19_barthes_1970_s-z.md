---
title: "S/Z — 5 つのコードによる段階的テクスト分析"
description: "Barthes (1970/2002) Blackwell 書籍。バルザックの『サラジーヌ』を 561 のレクシアに分割し、解釈学的・意味素・象徴的・行為項的・文化的の 5 つのコードで横断的に読み解く『段階的分析』を展開した、構造主義から後構造主義への転換を画する古典。"
aliases: ["S/Z", "five codes", "writerly text"]
tags: [source, "D19", "原典解説"]
source:
  repo: "creation-space"
  path: "knowledge/wiki/D19/D19-S10_barthes-1970.md"
  manifest_id: "D19-S10"
  oa_url: "https://monoskop.org/images/d/d6/Barthes_Roland_S-Z_2002.pdf"
compiled: "2026-04-18"
status: 暫定
review_state: 未レビュー
---
...
1. **HER**（hermeneutic code）: 謎の提示・遅延・解決を司るコード。タイトル「サラジーヌ」自体が最初の謎（名前は男か女か）を提起する
2. **SEM**（code of semes）: コノテーションの単位。シニフィエの「ちらつき」を記録する
3. **ACT**（proairetic code）: 行為の連鎖。人間行動の合理的帰結としての物語進行を司る
4. **REF**（cultural/reference codes）: 慣用句・格言・科学的知識など、集合的・匿名的な文化的声
5. **SYM**（symbolic code）: 対立項（A/B）の場。象徴的意味の深層構造を形成する
...
- cs 側読解: `creation-space/knowledge/wiki/D19/D19-S10_barthes-1970.md`（2026-04-16、claude-opus-4-6, Read PDF。Preface + Sections I-XI 読了）
