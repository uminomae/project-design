...
source:
  repo: "creation-space"
  path: "knowledge/source-notes/D01/D01-S09_perelman-2002.md"
  manifest_id: "D01-S09"
...
- **cs 原典ファイル**: [knowledge/source-notes/D01/D01-S09_perelman-2002.md](https://github.com/uminomae/creation-space/blob/main/knowledge/source-notes/D01/D01-S09_perelman-2002.md)（manifest_id: `D01-S09`）
- **cs 精読ノート**: [knowledge/source-notes/D01/D01-S09_perelman-2002.md](https://github.com/uminomae/creation-space/blob/main/knowledge/source-notes/D01/D01-S09_perelman-2002.md)
- **この wiki ページ（pd）**: [wiki/sources/D01_perelman_2002_2002.md](https://github.com/uminomae/project-design/blob/main/wiki/sources/D01_perelman_2002_2002.md)
- **参照先（原典 DOI / オープンアクセス）**: 下記「書誌情報」を参照

## 出典メモ

- cs 側読解: `creation-space/knowledge/source-notes/D01/D01-S09_perelman-2002.md`（2026-04-13、Claude Opus 4.6, WebFetch → Read PDF。Introduction + §1, §3-§5, §12.2-§13 抜粋読解）
