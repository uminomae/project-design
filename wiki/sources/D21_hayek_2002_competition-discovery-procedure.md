...
PD（プロジェクトデザイン論）においてHayekの発見手続き論は、「プロジェクトにおける知識の問題」と深く接続する。プロジェクトに関わる知識——誰が何を知っているか、どのリソースが利用可能か、何が参加者の動機を形成するか——は事前に中央集権的に把握できるものではない。プロジェクトの進行プロセス自体が、これらの知識を「発見する手続き」として機能する。また競争の価値が「結果の予測不可能性」にあるというHayekの主張は、PD における「プロセスとして起きていること（Being）」の重要性——計画されない発見・意図されない創造——を理論的に支持する。さらにパターン予測という方法論的制約の受容は、PD が「プロジェクトの全体像を事前に確定できない」という前提を持つことと共鳴する。
