...
総合的防除の概念は「生態系をシステムとして管理する」という視点を提供する。プロジェクトデザイン論の観点では、プロジェクト環境も生態系と同様に多数のアクターが相互作用する複雑系である。一点集中的な「力技」（大量化学農薬 = 権威的トップダウン指示）は短期的効果をもたらす反面、システム全体のレジリエンスを損なう。一般均衡位置・経済的閾値という枠組みは、「どの問題に介入すべきか」「いつ介入すべきか」を判断する際の合理的基準として、PD における意思決定のタイミング論と接続する。
