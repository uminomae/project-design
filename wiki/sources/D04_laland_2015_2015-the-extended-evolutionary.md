---
title: "拡張進化的総合説（EES）— その構造・仮定・予測"
description: "Laland ら (2015) Proc R Soc B 論文。進化発生学・発生的可塑性・包括的遺伝・ニッチ構築を統合し、自然選択以外も適応の生成に責任を共有する『拡張進化的総合説（EES）』を体系的に提示した。"
aliases: ["The extended evolutionary synthesis", "EES"]
