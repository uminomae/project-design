...
PD（プロジェクトデザイン論）においてSchumpeterの初版は、プロジェクトの「創発的・変革的側面」を理論化する際の重要な参照点となる。「新結合の実行」としての起業家機能は、プロジェクトが既存の慣行・制度・リソース配分を「内側から」変える行為として読み換えられる。また静態的な循環からの逸脱として発展を定義する枠組みは、PD が「やること（Doing）」の新規性と「起きていること（Being）」の既成秩序との緊張関係を捉える際の理論的土台になり得る。さらに初版のエネルギー・意志・知識を持つ行為者像は、Love駆動開発における「内発的動機によって動く人間」の概念と共鳴する。
