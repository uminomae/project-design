...
プロジェクトデザイン論は「やること（Doing）」と「起きていること（Being）」を含む複雑な出来事の構造を扱う。TDAが提示する「データの形状」という概念は、PD における「プロジェクトの構造」をどう捉えるかに共鳴する。特に、スケールに依存せず持続する特徴を信号とみなす永続ホモロジーの発想は、プロジェクト進行中に生まれ消える出来事の中から「本質的な構造」を識別する視点と接続できる。また、欠損駆動思考における「欠損の同定」も、高次元の経験データから意味ある特徴を取り出す行為として位相的アナロジーを持つ。
