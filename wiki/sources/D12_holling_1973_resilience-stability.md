...
プロジェクトデザイン論においてレジリエンスの概念は核心的な問いと接続する。プロジェクトは計画通りに進む「安定性」を目標とすることが多いが、Holling の議論に倣えば、安定性の追求がかえってプロジェクトの適応能力を損なう危険がある。「Being（起きていること）」の次元への注目は、プロジェクトを単一の均衡に向かわせる制御ではなく、複数の安定状態を行き来しながら機能を維持する「レジリエンス型の運営」として理解する可能性を開く。外乱を異常として排除するのではなく、吸収して学習するプロセスとして捉えることが PD の実践論に示唆を与える。
