...
プロジェクトデザイン論における「Being（起きていること）」の探索は、参加者が自己の変容プロセスをどのように認識し語るかという問いと結びつく。木下の研究が示す「時間的に拡張された自己」の発達は、人がプロジェクト経験を過去-現在-未来の連続として意味づける能力の基盤である。自己の変容を「自分のこと」として引き受ける能力の発達的基盤を理解することは、PD が扱う自己認識・振り返り・内省の過程を考える上で重要な参照点となる。
