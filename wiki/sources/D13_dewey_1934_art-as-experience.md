...
探究・思考論の観点からは、本書は「完結した経験の条件」「表現における抵抗と解決」「リズムによる形式化」を論じた著作として読める。プロジェクトは「ひとつの経験」たりうるかという問いに対し、デューイは開始・中間・終了の内的統一性と、テンションの解消による充実を条件として挙げる。プロジェクトの完了感・達成感とは何かを考えるとき、この「ひとつの経験」概念は示唆に富む。また表現が「放出ではなくプロセスを通じた洗練」であるという視点は、プロジェクトの成果物が単なる要求実現ではなくプロセスによって形成されるという PD の本質と通じる。
