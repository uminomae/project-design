...
プロジェクトデザイン論が関心を持つ「信念・価値観の変容」「コミュニティへの所属と離脱」「変容の自発性と強制性」という問題群に対して、本論文は重要な示唆を与える。特に、変容プロセスが外部から一方的に管理・介入されるとき何が起きるかという問いは、PD が扱うプロジェクト参加者の変容の自律性と外部的圧力の関係を考える上で参照点となる。宗教的改宗というラジカルな変容事例は、より一般的な変容プロセスの極端な形として理解できる。
