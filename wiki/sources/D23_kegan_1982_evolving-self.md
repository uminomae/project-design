...
プロジェクトデザイン論が探索する「やること（Doing）と起きていること（Being）の両方を含む出来事としてのプロジェクト」は、参加者の意味形成の変容プロセスを内包する。キーガンの構成的発達理論は、プロジェクトの中で人がどのように変容するか（あるいは変容を拒むか）を記述する言語を提供する。とりわけ「主体が客体化される転換」は、PD が扱う自己への気づき・役割意識の変化・内省の深まりと接続する。プロジェクトという場が「埋め込まれた文化」として機能し、参加者の発達段階に応じた保持と挑戦の環境を形成するという視点も有効である。
