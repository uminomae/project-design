...
> **高校生向けのやさしい解説**
>
> 「ノイズだらけの電話線でも、情報をどれくらい正確に届けられるか」を数学で測った1948年の論文です。シャノンは情報の量を「ビット」という単位で表す方法を考え、どんなにノイズがあっても工夫次第で誤りをほぼゼロにできる限界値（チャンネル容量）を証明しました。スマホの通信やQRコードの誤り訂正など、今の情報技術の根っこになっている理論です。
