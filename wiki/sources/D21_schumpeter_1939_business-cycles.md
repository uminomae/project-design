...
シュンペーターの景気循環論はプロジェクトデザイン論に多層的な示唆を持つ。創造的破壊の概念は、プロジェクトにおける「新しいものを作ることは古い構造を壊すこと」という認識と直結する。変化に抵抗が伴うのは構造的必然であり、抵抗それ自体がイノベーションの証拠でもある。三波モデルが示す「異なるリズムの循環の重ね合わせ」は、プロジェクトが短期・中期・長期の複数のリズムで同時に動いており、それぞれの位相を読み取ることの重要性を示す。企業家概念における「信用による新結合の実行」は、プロジェクトが現在の資源制約を超えて未来の可能性に賭けるという構造——借り入れによる実行——を正当化する。欠損駆動思考との関連では、既存均衡への欠損感がイノベーションを引き起こすシュンペーターの企業家像と、欠損を起点として新たな可能性を探索するという実践が構造的に対応する。
