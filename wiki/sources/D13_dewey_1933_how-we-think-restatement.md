...
1933年版の意義はとくに「探究の態度」の強調にある。プロジェクトデザイン論では、単に手順を実行する能力だけでなく、不確実な状況に開放的に向き合い、仮説を立て、結果への責任を引き受ける態度が問われる。開放的心・誠実さ・責任感という三つの態度は、PD における「Being（あり方）」の次元——プロジェクトを推進する人間の内的状態——と直接接続する。また五段階の探究構造はプロジェクトの意思決定サイクルの雛形として参照できる。
