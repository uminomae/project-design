---
title: "予測的な脳と状況づけられたエージェント — 階層的予測処理の射程"
description: "Clark (2013) BBS target article。脳の本質を『予測誤差の最小化』とする階層的予測処理の枠組みを統合的に検討し、知覚・行為・注意・意識を統一的に説明する候補として評価する。"
aliases: ["Whatever next?", "Predictive brains", "hierarchical predictive processing"]
