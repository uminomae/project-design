...
> **高校生向けのやさしい解説**
>
> フライパンに油を入れて弱火にかけると、やがて油の表面に六角形の模様が現れることがあります——これがベナール対流です。レイリー卿はこの現象を数学で解明し、「温度差がある一定の値を超えると流体が自然に規則正しく動き始める」ことを理論で示しました。自然に生まれる秩序がいつ出現するかを決める「レイリー数」という指標は、この論文から生まれました。
