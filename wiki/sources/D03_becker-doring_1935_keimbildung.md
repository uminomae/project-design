...
Becker-Döring の核形成理論は、PD における「新しいプロジェクトの発生」や「転換点」のモデルとして示唆に富む。過飽和状態（潜在的な変化の準備が整っている状態）においても、臨界核（最初の具体的な動き）が揺らぎによって形成されるまで相転移が起きないという構造は、「機が熟しても何かのきっかけがなければ動かない」という人間の経験に対応する。また、臨界半径という概念——これより小さければ消えてしまい、これより大きければ自己増幅する閾値——は、プロジェクトの「臨界質量」という PD 的考察を支持する物理モデルとなる。「揺らぎによる臨界核の生成」という機制は、偶発的な出来事がプロジェクトの出発点となる様子と構造的に類似している。
