...
モース理論はプロジェクトデザイン（PD）において「臨界点」という概念的フレームを提供する。PD の文脈では、プロジェクトを「やること（Doing）」と「起きていること（Being）」を含む出来事として捉えるが、この出来事の展開には必ず変曲点や転換点——すなわち臨界点——が存在する。

モース理論が示すのは、こうした臨界点が多様体（システム全体）のトポロジーそのものを変える契機になるという事実である。プロジェクトにおける危機や転換は単なる「問題」ではなく、プロジェクト空間の位相的構造を変化させる出来事として理解できる。また、モース不等式の (1+t) 因子が「臨界点から全体構造へのフィードバック」を表すように、局所的な転換点の観察がプロジェクト全体のあり方を照らし出す可能性を示唆する。
