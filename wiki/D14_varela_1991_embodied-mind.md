...
本著作はプロジェクトデザイン論の心理学的基盤として複数の接続点を持つ。まず、PDが「プロジェクト = やること（Doing）＋起きていること（Being）」として捉える視点は、enactionにおける「行為者と環境の共同生成」という構造と対応する。プロジェクトの「Being（起きていること）」は外部から与えられた客観的状態ではなく、プロジェクトの参加者が身体化された関与を通じて共に構成するものとして理解できる。次に、Love駆動開発が関係・感情・意図を設計の中核に据える立場は、認知が純粋な情報処理ではなく身体と感情と社会的文脈に根ざしているというenactionの主張と整合する。さらに「自己の非統一性」という問いは、プロジェクトの担い手としての「自分」が固定した行為主体ではなく、状況の中で動的に形成されるという理解を支える。
