...
- **進行中**: 実部=場・虚部=人の論拠補強（pjdhiro「論拠のない設定なので補強してほしい」）→ 数学接地＋現象学/社会科学接地の2本調査 → **RR-015 予定**。現象学側完了（支持最強=Tomasello 共同注意／反証最強=Lewin life space／物理の場アナロジー危険／3人拡張は文献空白）。数学側は G₂ 検証の仕上げ中
