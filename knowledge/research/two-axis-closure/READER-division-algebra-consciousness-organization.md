...
> **pjdhiro の見方：** 四元数は、3次元の回転を表す道具です。その虚の3方向（i, j, k）が、ちょうど3人にあたるとみると、しっくりきます（3次元の回転＝3者）。しかも回転として扱いたいので、大きさ1の世界（単位球）で見たい。それで、実部は人数に数えないことにしました。

念のため、この出発点は pjdhiro 自身の発案です。「虚の方向を人にあて、実部は人数に数えない」という置き方を最初に提案したのは Fable5 ではなく pjdhiro のほうで、Fable5 はそのあとに、なぜそう置けるのかの数学的な裏づけ（下の三つの理由）を担いました。この読み物は Fable5 が書いていますが、鍵になる枠組み——回転（四元数）と3人を結び、単位球で見るために実部を外す——は、人間の側から出ています。どこまでが人の直観で、どこからが機械の裏づけか、切り分けて記しておきます。

ただ、この置き方には当然の反論があります。「実部だって、i・j・k と直交する基底の一本ではないか。なぜ、それだけ人に数えないのか」。この問いに、数学の側から答えられます。実軸だけが、他のすべての軸と違う特別扱いを受けているからです。理由は三つあります。
