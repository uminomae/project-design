...
> 📖 **人間関係の「掛け算」とは何か** — ここがこの読み物のいちばん大事な賭けなので、はっきり書いておく。
>
> **A × B ＝ 「A と B が関わった結果」が着地する場所**、と読む。
>
> - A と B が議論する・共同作業する・ぶつかる——その**帰結（決着・成果物・もつれ）は、二人の間だけでは完結しない**。誰かが引き取る必要がある。
> - 3人チームなら、A と B の関わりの着地点を **C が引き取る**——仲裁する、レビューして統合する、もつれを調停する。これが「A × B ＝ C」の意味。
> - **C に何が起きるか**: C は A–B ペアの関わりの**受け皿**になる。C の仕事や負荷は、自分が直接関わっていない二人の活動からも決まってくる。チームで働いたことがある人なら、身に覚えがあるはずだ。
> - **向き（±）**: A が主導して B に働きかけた帰結と、B が主導した帰結では、C に届くものの「向き」が違う（どちらの案が通ったか）。`i·j = k` と `j·i = −k` の符号は、これを写している。
> - **正直な注意**: この読みは**解釈の賭け**であって、証明された事実ではない（§10「どこまでが数学か」）。ただし賭けは検証できる形にしてある——§7 の予測「よく回る7人チームでは、どのペアにも帰結の持ち込み先がちょうど一人に決まっている」が、この掛け算読みのテストだ。
...
>
> **もしも人間関係でいうなら**——ホームとは「**その二人の件の持ち込み先**」。ホームがない＝二人のもつれを引き取る人がいない。ホームが2つ＝「あの件、誰に上げればいい?」が毎回曖昧になる。
