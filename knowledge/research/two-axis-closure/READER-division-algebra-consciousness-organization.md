...
>
> **背景：なぜこれを考えたか。** 私はチームを組むたびに、3人だとよく回り、7人を超えると急に重くなる、と体で感じてきました。同じころ、自分の意識には「物質的な生存」と「精神的な信頼」という二つの手ごたえが同時に流れているとも感じていました。この二つの体験が同じ形をしているのではないか、というのが出発点の問いです。 そしてもともと私は、意識をベクトル、感情をそこから流れるエネルギーのようなものとして見ています。ベクトルやエネルギーなら、動きを回転の数学で書けるかもしれない——そう思ったのが、経営でいう「掛け算」を回転の掛け算として考えはじめた理由です。
>
...
**私の物事の見方（この読み物の前提）。**
先に、この先を読むときの前提になる、私の物事の見方を置いておきます。確かめられた事実ではなく、私がそう感じている、という出発点の見方です。

- 私は、意識を、**物質（生存）と精神（信頼）という二つの方向を持つ、ベクトルのようなもの**として感じています。どちらへどれだけ傾くかで、その人の意思や価値観の向きが決まる、というイメージです。
- そして感情を、そこから流れ出す**エネルギーのようなもの**として感じています。円環のようにめぐり、色や偏りを持ち、他者と関わるときに放出される——魂や愛のダムから流れ出す何か、というような。ひょっとすると、熱力学や宇宙や量子のエネルギーと、構造が似ているのかもしれません（ここは、まだ光のように未知な、私の見立てです）。

**この見方があるから、回転の数学を持ち出しています。** ベクトルやエネルギーなら、その動きは「足し引き」よりも「回転」で書けるはずです。そして、回転を正確に扱う数学が、実際にあります（複素数や四元数。<a href="#2-回る数--虚数そして四元数">§2</a>）。だから私は、経営でよく言う「掛け算」を、**回転の掛け算**として考えてみたくなりました。数学を使うのは、そのほうが偉そうに見えるからでも、話を難しくしたいからでもありません。この見方から、自然にそうなるからです。
...
ここでは、場を実軸・人を虚軸とみる側から、「二人（2名）」という状態の意味を補足します。
...
- **解釈の賭け**: 人を虚軸・場を実軸に対応させて読むこと（未証明の読み）。
...
**ここで、視点が一つ動きます。** 「偶数はもめて、奇数は決まる」には、多数決の算術だけでなく、この二部性という構造の裏づけもある、と見えてきます。すると、膠着の本当の相手が入れ替わります。それは人数の偶奇そのものではなく、**分断線**——チームを二手に割る、一本の対立の軸——のほうです。
...
逆に、**分断線が一本に揃わなければ、二陣営そのものができません**。役割の線、専門の線、世代の線が、それぞれ別の方向に走っていて重ならない——このとき、ある線で敵でも、別の線では味方になります。誰も「完全な向こう側」に固定されないので、二派に割れません（社会学ではこれを「交差する亀裂」と呼びます——Lipset や Coser の議論です）。
