...
>
> **正直な注意を二つ**。第一に、この「回し方の合成」という読みは**解釈の賭け**であり、まだ検証の途中（§7 結果1）。第二に、これを観測するときは「どのペアの件も、着地する第三の軸（ホーム）が一意に決まっているか」という**粗い代理指標**に落とす（§7 結果3）——代理は意味そのものではない。
