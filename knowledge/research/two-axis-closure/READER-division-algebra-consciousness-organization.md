...
**先に、この読み物で一番持ち帰ってほしいことを一つだけ書いておきます。** 「足し算ではなく、掛け算の経営」とは、たぶん、こういうことです。海の波を思い浮かべてください。小さな波がばらばらに来るときは、水面はあまり大きくなりません。波どうしが打ち消し合うからです。ところが、波の山と山がタイミングをそろえて重なると、一つの大きなうねりになります。同じ数、同じ大きさの波でも、そろうかどうかで結果はまるで違います。

つまり「掛け算の経営」とは、人を足して一人ひとりを強くすることではなく、**一人ひとりの波のタイミングをそろえて、大きなうねりや渦を立てること**ではないか、というのがこの読み物の見立てです。そして、そのタイミングをそろえる操作が「回転」です。なぜそう考えられるのかを、これから順に説明します（この見立ての中身は <a href="#3-なぜ-3-は特別か--掛け算ができる最小の人数">§3</a>）。もちろん、これも一つの見方にすぎませんが、この読み物を通して一番伝えたい気づきです。
...
冒頭の海のうねりも、拍手も、ブランコも、ボートも、言っていることは一つです。全体が大きくなるかどうかは、一つひとつの力の強さではなく、タイミング（位相）がそろっているかで決まります。回転は、力そのものを大きくする操作ではなく、このタイミングをそろえる操作です。冒頭で「掛け算の経営とは、波のタイミングをそろえて大きなうねりや渦を立てること」と書いたのは、この意味です。
