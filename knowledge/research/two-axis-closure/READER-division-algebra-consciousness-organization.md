...
**組織論に数学を使う理由。** 私は、二つのものを、こう整理できるかもしれないと感じています（私の仮説であり、価値観です）。

- **意識**は、物質（生存）と精神（信頼）の二方向を持つ**ベクトル**のようなもの。
- **感情**は、そこから流れ出す**エネルギー**のようなもの。

ベクトルやエネルギーなら、その動きは回転で書けるかもしれない。だから、経営でいう「掛け算」を**回転の掛け算**として考えています（回転を表す数が複素数・四元数。<a href="#2-回る数--虚数そして四元数">§2</a>）。
