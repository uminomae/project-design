...
**組織論に数学を使う理由。** ベクトルやエネルギーなら、その動きは「足し引き」よりも「回転」で書けるはずです。そして、回転を正確に扱う数学が、実際にあります（複素数や四元数。<a href="#2-回る数--虚数そして四元数">§2</a>）。だから私は、経営でよく言う「掛け算」を、**回転の掛け算**として考えてみたくなりました。
