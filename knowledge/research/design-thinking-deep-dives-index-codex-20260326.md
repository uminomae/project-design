# デザイン思考サブイシュー深掘りインデックス

作成日: 2026-03-26  
作成: Codex  
親Issue: #6
関連Issue: #11, #12, #13, #14, #15, #16, #17

## 概要

`design thinking` 総論レポートを起点に、今後の深掘りを issue 駆動で分割していくためのインデックス。
...
- 現時点の結論は「design thinking の核心は abductive-framing にあるが、Peirce の原義からはそのまま一直線ではない」
...
- issue はすべて親Issue #6 配下として扱う
- 命名規則は `design-thinking-{slug}-deep-dive-codex-YYYYMMDD.md`
- 進捗は親Issueコメントとこのインデックスの両方に残す
