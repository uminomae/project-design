...
`信頼とは何か` の広域レビューを起点に、次の 3 本を独立レポートとして深掘りした。

- **愛着と信頼**: 発達・臨床・認識論的信頼の接続
- **信頼の神経現象学**: lived experience と第三者データの橋渡し
...
- 今後の焦点は、愛着安全性と generalized trust の媒介経路、臨床 ET の測定妥当性、self-trust の心理学的操作化。
...
- 今後の焦点は、micro-phenomenology と dyadic task をつないだ exploratory taxonomy の構築。
...
- 今後の焦点は、self-report 偏重から reliance dynamics と failure/recovery 研究への移行。
...
- 愛着レーンでは安全基地と関係的予測
- 神経現象学レーンでは lived structure
- AI レーンでは校正された依存

同じ `trust` でも対象・水準・方法が違う。

### 2.2 vulnerability は共通するが内容は違う

- 親密圏では見捨てられうること
- 神経現象学では監視を緩めること
- AI では故障・誤作動・責任不明の中で依存すること

### 2.3 repair は再説明ではなく再学習

- 愛着と臨床では、再び委ねられるかが核心
- 神経現象学では、身体化された安全感の回復が候補になる
- AI では、故障後の recalibration が核心
