...
export const TRANSLATIONS = {
    ja: {
        ...
        'howto.map.as': '内受容感覚・予測-誤差ループ・F-O評価・抱持の4層モデルで意識の構造を探索',
    ...
    en: {
        ...
        'howto.map.as': 'Exploring consciousness through a four-layer model: interoception, prediction-error loop, F-O evaluation, and withholding',
